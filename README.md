...
🗣️ **Natural Language Processing:** Deep expertise in **Vietnamese NLP** using **PhoBERT** and transformer models. Successfully built sentiment analysis systems achieving **98.35% accuracy**, chatbots with **RAG architecture**, and multimodal language understanding systems for both Vietnamese and Spanish.

💻 **Full-Stack Development:** Proficient in building scalable web applications with modern tech stacks (**React**, **Next.js**, **Angular**, **Node.js**, **FastAPI**). I architect end-to-end solutions from database design to responsive UIs, with experience in **microservices**, **real-time systems** (WebSocket, SSE), and **cloud deployment**.

⛓️ **Blockchain & Web3:** Hands-on experience integrating **blockchain technology** for verifiable credentials and decentralized identity systems, working with platforms like **Truvera** and **Ethereum**.

💡 **Problem Solver:** I thrive on tackling complex challenges—from designing **AI-powered financial systems** to building **intelligent tour booking platforms**. My projects demonstrate a unique blend of cutting-edge AI research and practical software engineering, always focused on delivering **real-world value**.
